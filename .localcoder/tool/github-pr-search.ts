...
import { tool } from "@localcoder-ai/plugin"
...
This tool searches PRs in the anomalyco/localcoder repository and returns LLM-friendly results including:
- PR number and title
- Author

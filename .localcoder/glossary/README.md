...
Use this folder for locale-specific translation guidance that supplements `.localcoder/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/localcoder/pull/12345

## Do Not Translate (Locale Additions)

- `LocalCoder` (preserve casing)

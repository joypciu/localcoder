...
- PR #15835: https://github.com/anomalyco/localcoder/pull/15835

## Do Not Translate (Locale Additions)

- `LocalCoder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `localcoder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `LocalCoder` in prose, `localcoder` only for exact technical identifiers
...
- Avoid changing `localcoder` to `LocalCoder` inside commands, URLs, package names, or code literals

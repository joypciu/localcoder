...
- PR #13942: https://github.com/anomalyco/localcoder/pull/13942

## Do Not Translate (Locale Additions)

- `LocalCoder` (preserve casing in prose; keep `localcoder` only when it is part of commands, package names, paths, or code)
- `LocalCoder Zen`
- `LocalCoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `localcoder` in prose when referring to the product name; use `LocalCoder`

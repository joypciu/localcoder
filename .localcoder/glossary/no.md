...
- PR #10018: https://github.com/anomalyco/localcoder/pull/10018
- PR #12935: https://github.com/anomalyco/localcoder/pull/12935

## Do Not Translate (Locale Additions)

- `LocalCoder` (preserve casing in prose; keep `localcoder` only in commands, package names, paths, or code)
- `LocalCoder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/localcoder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/localcoder...\n")
...
console.log("Fetching npm all-time downloads for localcoder-ai...\n")
const npmDownloads = await fetchNpmDownloads("localcoder-ai")

...
import desktopAppIcon from "../../asset/lander/localcoder-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://localcoder.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>localcoder.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g localcoder-ai")}>
                <code>
                  npm i -g <strong>localcoder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g localcoder-ai")}>
                <code>
                  bun add -g <strong>localcoder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/localcoder")}>
                <code>
                  brew install <strong>anomalyco/tap/localcoder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S localcoder")}>
                <code>
                  paru -S <strong>localcoder</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask localcoder-desktop")}>
                <code>
                  brew install --cask <strong>localcoder-desktop</strong>
                </code>
                <CopyStatus />
              </button>

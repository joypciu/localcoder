...
import compareVideo from "../../asset/lander/localcoder-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/localcoder-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="localcoder:auth" content={loggedin() ? "true" : "false"} />

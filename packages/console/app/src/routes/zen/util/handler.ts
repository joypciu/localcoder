...
import { and, Database, eq, isNull, lt, or, sql } from "@localcoder-ai/console-core/drizzle/index.js"
import { KeyTable } from "@localcoder-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@localcoder-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@localcoder-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@localcoder-ai/console-core/util/date.js"
import { Identifier } from "@localcoder-ai/console-core/identifier.js"
import { Billing } from "@localcoder-ai/console-core/billing.js"
import { Actor } from "@localcoder-ai/console-core/actor.js"
import { WorkspaceTable } from "@localcoder-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@localcoder-ai/console-core/model.js"
import { Subscription } from "@localcoder-ai/console-core/subscription.js"
import { BlackData } from "@localcoder-ai/console-core/black.js"
import { UserTable } from "@localcoder-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@localcoder-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@localcoder-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@localcoder-ai/console-core/lite.js"
import { Resource } from "@localcoder-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-localcoder-session") ?? ""
    const requestId = input.request.headers.get("x-localcoder-request") ?? ""
    const projectId = input.request.headers.get("x-localcoder-project") ?? ""
    const ocClient = input.request.headers.get("x-localcoder-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-localcoder-request")
          headers.delete("x-localcoder-session")
          headers.delete("x-localcoder-project")
          headers.delete("x-localcoder-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://localcoder.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://localcoder.ai/workspace/${authInfo.workspaceID}/members`

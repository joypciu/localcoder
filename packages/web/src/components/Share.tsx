...
import { Iconlocalcoder } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "localcoder/session/message-v2"
import type { Message } from "localcoder/session/message"
import type { Session } from "localcoder/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.localcoder_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.localcoder_name}>
                    <Iconlocalcoder width={16} height={16} />
                  </div>

---
title: TUI
description: Usando a interface de usuário de terminal localcoder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O localcoder fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar localcoder inicia o TUI para o diretório atual.
...
Ao usar o TUI do localcoder, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao localcoder. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do localcoder. _Aliases_: `/quit`, `/q`
...
Isso é separado do `localcoder.json`, que configura o comportamento do servidor/runtime.
...
Use `LOCALCODER_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.

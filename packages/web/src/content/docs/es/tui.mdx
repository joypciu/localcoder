---
title: TUI
description: Usando la interfaz de usuario del terminal LocalCoder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCoder proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar LocalCoder se inicia TUI para el directorio actual.
...
Cuando utilice LocalCoder TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a LocalCoder. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de LocalCoder. _Alias_: `/quit`, `/q`
...
Esto es independiente de `localcoder.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `LOCALCODER_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.

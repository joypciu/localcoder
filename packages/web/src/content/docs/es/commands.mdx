...
Crear `.localcoder/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración LocalCoder o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su LocalCoder [config](/docs/config):
...
- Por proyecto: `.localcoder/commands/`
...
localcoder incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

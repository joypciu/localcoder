...
Agentferdigheter lar LocalCoder oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går LocalCoder opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
LocalCoder viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `localcoder.json`:

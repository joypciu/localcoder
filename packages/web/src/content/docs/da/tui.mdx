---
title: TUI
description: Brug af LocalCoder-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCoder giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre LocalCoder starter TUI for den nuværende mappe.
...
Når du bruger LocalCoder TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til LocalCoder. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut LocalCoder. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `localcoder.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `LOCALCODER_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.

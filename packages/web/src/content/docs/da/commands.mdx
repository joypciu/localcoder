...
Opret `.localcoder/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem LocalCoder-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din LocalCoder [config](/docs/config):
...
- Globalt: `~/.config/localcoder/commands/`
- Pr. projekt: `.localcoder/commands/`
...
localcoder indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

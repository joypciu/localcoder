...
Brug den til at bygge integrasjoner og kontrollere localcoder programmatisk.
...
Opret en forekomst av localcoder:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `localcoder.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av localcoder, kan du oprete en klientforekomst for at koble til den:

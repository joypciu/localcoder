---
title: LSP-servere
description: LocalCoder integreres med dine LSP-servere.
---

LocalCoder integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

LocalCoder leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `LOCALCODER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når localcoder åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din localcoder-konfiguration.

...
Der er to typer agenter i LocalCoder; primære agenter og subagenter.
...
LocalCoder leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
LocalCoder leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

LocalCoder leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `localcoder.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger LocalCoder modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale LocalCoder-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din LocalCoder-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [LocalCoder Zen](/docs/zen), vil du bruge `localcoder/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `localcoder models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/localcoder).
:::

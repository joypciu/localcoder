---
title: TUI
description: استخدام واجهة المستخدم TUI في LocalCoder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر LocalCoder واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل LocalCoder إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة LocalCoder في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى LocalCoder. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من LocalCoder. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات LocalCoder.
...
استخدم `LOCALCODER_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.

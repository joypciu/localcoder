...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في localcoder.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في localcoder مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.localcoder/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/localcoder/tools/`.

...
يوجد نوعان من الوكلاء في LocalCoder: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي LocalCoder مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي LocalCoder مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي LocalCoder مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `localcoder.json`:
...
- عام: `~/.config/localcoder/agents/`
- لكل مشروع: `.localcoder/agents/`
...
إذا لم يتم تحديد temperature، يستخدم LocalCoder القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات LocalCoder العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات LocalCoder الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [LocalCoder Zen](/docs/zen)، فستستخدم `localcoder/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `localcoder models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/localcoder).
:::

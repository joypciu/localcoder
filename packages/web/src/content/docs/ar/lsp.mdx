---
title: خوادم LSP
description: يتكامل LocalCoder مع خوادم LSP لديك.
---

يتكامل LocalCoder مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي LocalCoder مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `LOCALCODER_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح localcoder ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات localcoder.

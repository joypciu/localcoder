...
Utwórz `.localcoder/commands/test.md`:
...
Możesz zdefiniować polecenia w `localcoder.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji localcoder:
...
- Globalnie: `~/.config/localcoder/commands/`
- Na projekt: `.localcoder/commands/`
...
localcoder zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

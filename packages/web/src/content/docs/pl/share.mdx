---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące localcoder.
---

Funkcja udostępniania localcoder umożliwia tworzenie publicznych linków do konwersacji localcoder, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, localcoder:
...
localcoder obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie localcoder korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `localcoder.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu localcoder w Twojej organizacji.

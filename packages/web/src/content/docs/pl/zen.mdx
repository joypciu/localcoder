---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez LocalCoder.
---
...
LocalCoder Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół LocalCoder.

:::note
LocalCoder Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w LocalCoder. Logujesz się do LocalCoder Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z LocalCoder.
:::
...
LocalCoder Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

LocalCoder Zen działa jak każdy inny dostawca w LocalCoder.

1. Logujesz się do **<a href={console}>LocalCoder Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz LocalCoder Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji LocalCoder używa formatu
`localcoder/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`localcoder/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w LocalCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w LocalCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w LocalCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w LocalCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w LocalCoder przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy LocalCoder Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w LocalCoder także dowolnego innego dostawcy.

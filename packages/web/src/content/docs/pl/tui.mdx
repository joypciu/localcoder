---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala localcoder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

localcoder zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie localcoder uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI localcoder, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do localcoder. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij localcoder. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `localcoder.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `LOCALCODER_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.

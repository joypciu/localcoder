...
`.localcoder/commands/test.md` oluştur:
...
localcoder işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

localcoder [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/localcoder/commands/`
- Proje başına: `.localcoder/commands/`
...
localcoder, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

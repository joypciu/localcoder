---
title: Özel Araçlar
description: LLM'un localcoder'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. localcoder'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.localcoder/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/localcoder/tools/` içine yerleştirerek.

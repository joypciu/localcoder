---
title: SDK
description: localcoder sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

localcoder JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
localcoder'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir localcoder örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `localcoder.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir localcoder örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:

...
description: localcoder dile özgü biçimlendiriciler kullanır.
---

localcoder, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

localcoder, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, localcoder bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

localcoder bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri localcoder yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.

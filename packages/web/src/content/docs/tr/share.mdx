---
title: Paylasim
description: localcoder konusmalarini genel baglantilarla paylasin.
---

localcoder'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda localcoder:
...
localcoder, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak localcoder manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `localcoder.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda localcoder kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

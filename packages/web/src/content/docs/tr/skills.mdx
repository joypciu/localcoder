...
Ajan becerileri, localcoder'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
localcoder su konumlari tarar:

- Proje konfigurasyonu: `.localcoder/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/localcoder/skills/<name>/SKILL.md`
...
Proje yerel yollarinda localcoder, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.localcoder/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/localcoder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.localcoder/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
localcoder, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`localcoder.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`localcoder.json` icinde):

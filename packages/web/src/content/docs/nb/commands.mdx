...
Opprett `.localcoder/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom LocalCoder-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i LocalCoder [config](/docs/config):
...
- Per prosjekt: `.localcoder/commands/`
...
LocalCoder inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

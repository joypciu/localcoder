---
title: TUI
description: Bruke localcoder-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCoder gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre LocalCoder starter TUI for gjeldende katalog.
...
Når du bruker LocalCoder TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til LocalCoder. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt LocalCoder. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `localcoder.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `LOCALCODER_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.

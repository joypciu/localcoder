...
LocalCoder Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
LocalCoder Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i LocalCoder. Du abonnerer på LocalCoder Go og
...
LocalCoder Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

LocalCoder Go fungerer som enhver annen leverandør i LocalCoder.

1. Du logger inn på **<a href={console}>LocalCoder Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `LocalCoder Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på LocalCoder Go.
:::
...
LocalCoder Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din LocalCoder-konfigurasjon
bruker formatet `localcoder-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `localcoder-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet LocalCoder Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med LocalCoder også.

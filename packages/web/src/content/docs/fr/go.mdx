...
LocalCoder Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

:::note
LocalCoder Go est actuellement en version bêta.
:::

Go fonctionne comme n'importe quel autre fournisseur dans LocalCoder. Vous vous abonnez à LocalCoder Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser LocalCoder.
...
LocalCoder Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

LocalCoder Go fonctionne comme n'importe quel autre fournisseur dans LocalCoder.

1. Vous vous connectez à **<a href={console}>LocalCoder Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `LocalCoder Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à LocalCoder Go.
:::
...
LocalCoder Go inclut les limites suivantes :
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.1           | glm-5.1           | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5             | glm-5             | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5         | kimi-k2.5         | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Pro       | mimo-v2-pro       | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni      | mimo-v2-omni      | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M2.7      | minimax-m2.7      | `https://localcoder.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://localcoder.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus      | qwen3.5-plus      | `https://localcoder.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |

L'[ID de modèle](/docs/config/#models) dans votre configuration LocalCoder utilise le format `localcoder-go/<model-id>`. Par exemple, pour Kimi K2.6, vous utiliseriez `localcoder-go/kimi-k2.6` dans votre configuration.
...
```
https://localcoder.ai/zen/go/v1/models
```
...
Nous avons créé LocalCoder Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec LocalCoder également.

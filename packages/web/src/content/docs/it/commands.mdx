...
Crea `.localcoder/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di LocalCoder o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di LocalCoder:
...
- Globale: `~/.config/localcoder/commands/`
- Per progetto: `.localcoder/commands/`
...
localcoder include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

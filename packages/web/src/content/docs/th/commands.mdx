...
สร้าง `.localcoder/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ LocalCoder:
...
- ระดับผู้ใช้ (Global): `~/.config/localcoder/commands/`
- ระดับโปรเจ็กต์: `.localcoder/commands/`
...
LocalCoder มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

...
Create `.localcoder/commands/test.md`:
...
You can add custom commands through the LocalCoder config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your LocalCoder [config](/docs/config):
...
- Per-project: `.localcoder/commands/`
...
localcoder includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

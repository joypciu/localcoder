...
Kreiraj `.localcoder/commands/test.md`:
...
Možete dodati prilagođene komande kroz LocalCoder konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom LocalCoder [config](/docs/config):
...
- Globalno: `~/.config/localcoder/commands/`
- Po projektu: `.localcoder/commands/`
...
LocalCoder uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

---
title: TUI
description: Korištenje korisničkog interfejsa LocalCoder terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCoder pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje LocalCoder pokreće TUI za trenutni direktorij.
...
Kada koristite LocalCoder TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u LocalCoder. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz LocalCoder. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `localcoder.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `LOCALCODER_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.

---
title: SDK
description: Type-safe JS klijent za localcoder server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

localcoder JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje localcoder-om.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `localcoder.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu localcoder instancu, mozete napraviti klijentsku instancu i povezati se na nju:

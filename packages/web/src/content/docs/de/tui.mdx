---
title: TUI
description: Arbeite mit LocalCoder in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LocalCoder bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet LocalCoder die TUI im aktuellen Verzeichnis.
...
In der LocalCoder-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu LocalCoder hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet LocalCoder. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `localcoder.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `LOCALCODER_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.

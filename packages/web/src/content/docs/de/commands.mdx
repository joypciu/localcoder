...
Erstellen Sie `.localcoder/commands/test.md`:

```md title=".localcoder/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die LocalCoder-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem LocalCoder [config](/docs/config):

```json title="localcoder.jsonc" {4-12}
{
...
- Global: `~/.config/localcoder/commands/`
- Pro Projekt: `.localcoder/commands/`

```markdown title="~/.config/localcoder/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".localcoder/commands/component.md"
---
...
```md title=".localcoder/commands/create-file.md"
---
...
```md title=".localcoder/commands/analyze-coverage.md"
---
...
```md title=".localcoder/commands/review-changes.md"
---
...
```md title=".localcoder/commands/review-component.md"
---
...
LocalCoder enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

---
title: Teilen
description: Teile LocalCoder-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu LocalCoder-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht LocalCoder Folgendes:
...
LocalCoder hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt LocalCoder den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`localcoder.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du localcoder in deiner Organisation einsetzt.

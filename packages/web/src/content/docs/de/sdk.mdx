---
title: SDK
description: Typsicherer JS-Client fuer den localcoder-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das localcoder JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und localcoder programmatisch steuern.
...
Erstelle eine localcoder-Instanz:
...
`localcoder.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn localcoder bereits laeuft, kannst du nur einen Client erstellen und verbinden:

...
import { ensureProcessMetadata } from "../util/localcoder-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "localcoder",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "localcoder.client": Flag.LOCALCODER_CLIENT,
      "localcoder.process_role": processMetadata.processRole,
      "localcoder.run_id": processMetadata.runID,

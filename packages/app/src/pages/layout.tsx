...
import { ResizeHandle } from "@localcoder-ai/ui/resize-handle"
...
import { Session, type Message } from "@localcoder-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@localcoder-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@localcoder-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://localcoder.ai/desktop-feedback")}
      renderPanel={() =>

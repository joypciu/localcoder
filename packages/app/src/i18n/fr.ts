export const dict = {
  ...
  "dialog.provider.localcoder.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.localcoder.tagline": "Modèles optimisés et fiables",
  "dialog.provider.localcoderGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Visitez ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans localcoder.json",
  ...
  "dialog.server.description": "Changez le serveur LocalCoder auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'LocalCoder ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe LocalCoder",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (localcoder.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'LocalCoder ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "LocalCoder inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur LocalCoder dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour LocalCoder",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'LocalCoder sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si LocalCoder suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'LocalCoder.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'LocalCoder",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'LocalCoder.",

export const dict = {
  ...
  "dialog.provider.localcoder.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.localcoder.tagline": "Modelos optimizados y fiables",
  "dialog.provider.localcoderGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.localcoderZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.localcoderZen.visit.prefix": "Visita ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en localcoder.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de LocalCoder se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de LocalCoder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de LocalCoder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (localcoder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, LocalCoder no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor LocalCoder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para LocalCoder",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve LocalCoder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si LocalCoder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de LocalCoder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia LocalCoder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de LocalCoder.",

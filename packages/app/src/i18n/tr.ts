...
export const dict = {
  ...
  "dialog.provider.localcoder.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.localcoder.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.localcoderGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "LocalCoder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve LocalCoder'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve LocalCoder'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak LocalCoder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler localcoder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi LocalCoder sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "LocalCoder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı LocalCoder ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (localcoder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: LocalCoder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "LocalCoder Masaüstü",
  ...
  "settings.desktop.wsl.description": "LocalCoder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "LocalCoder'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "LocalCoder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "LocalCoder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "LocalCoder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "LocalCoder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "LocalCoder'un en son sürümünü kullanıyorsunuz.",

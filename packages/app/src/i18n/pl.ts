export const dict = {
  ...
  "dialog.provider.localcoder.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.localcoder.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.localcoderGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Odwiedź ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LocalCoder.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w localcoder.json",
  ...
  "dialog.server.description": "Przełącz serwer LocalCoder, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LocalCoder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LocalCoder",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (localcoder.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "LocalCoder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LocalCoder",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LocalCoder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LocalCoder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LocalCoder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LocalCoder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LocalCoder.",

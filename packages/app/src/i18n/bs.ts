export const dict = {
  ...
  "dialog.provider.localcoder.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.localcoder.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.localcoderGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u LocalCoder-u.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Posjeti ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u LocalCoder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u LocalCoder-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u localcoder.json",
  ...
  "dialog.server.description": "Promijeni na koji se LocalCoder server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija LocalCoder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku LocalCoder timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (localcoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: LocalCoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni LocalCoder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u LocalCoder-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako LocalCoder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li LocalCoder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu LocalCoder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se LocalCoder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju LocalCoder-a.",

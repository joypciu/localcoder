...
export const dict = {
  ...
  "dialog.provider.localcoder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.localcoder.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.localcoderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Besøk ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i localcoder.json",
  ...
  "dialog.server.description": "Bytt hvilken LocalCoder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av LocalCoder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til LocalCoder-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (localcoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at LocalCoder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør LocalCoder-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for LocalCoder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan LocalCoder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om LocalCoder skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan LocalCoder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når LocalCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av LocalCoder.",

export const dict = {
  ...
  "dialog.provider.localcoder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.localcoder.tagline": "Reliable optimized models",
  "dialog.provider.localcoderGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in LocalCoder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.localcoderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.localcoderZen.visit.prefix": "Visit ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins configured in localcoder.json",
  ...
  "dialog.server.description": "Switch which LocalCoder server this app connects to.",
  ...
  "toast.update.description": "A new version of LocalCoder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the LocalCoder team",
  ...
  "error.chain.checkConfig": "Check your config (localcoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, LocalCoder does not support MCP authentication yet.',
  ...
  "home.empty.description": "Set up a local model or cloud provider, then open a project folder to start chatting.",
  ...
  "sidebar.gettingStarted.line1": "LocalCoder includes free models so you can start immediately.",
  ...
  "app.name.desktop": "LocalCoder Desktop",
  ...
  "settings.desktop.wsl.description": "Run the LocalCoder server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for LocalCoder",
  ...
  "settings.general.row.appearance.description": "Customise how LocalCoder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether LocalCoder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how LocalCoder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when LocalCoder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of LocalCoder.",
  ...
  "home.tagline": "Local agents on your machine · multi-model · terminal-native precision",
  "home.action.setupLocal": "Set up local llama.cpp",
  "home.action.connectProvider": "Connect cloud provider",
  "home.setupHint": "Configure llama.cpp or a cloud provider first, then open a project folder to chat.",

  "dialog.llamacpp.title": "Local llama.cpp",
  "dialog.llamacpp.description": "Point LocalCoder at your llama-server folder and GGUF model. We save settings, configure the provider, and start the server for you.",
  "dialog.llamacpp.status.checking": "Checking local server status...",
  "dialog.llamacpp.status.running": "Running · {{model}}",
  "dialog.llamacpp.status.stopped": "Not running yet",
  "dialog.llamacpp.field.llamaDir": "llama.cpp folder",
  "dialog.llamacpp.field.llamaDir.placeholder": "Folder containing llama-server.exe",
  "dialog.llamacpp.field.modelPath": "GGUF model file",
  "dialog.llamacpp.field.modelPath.placeholder": "Path to your .gguf model",
  "dialog.llamacpp.action.browseLlamaDir": "Browse for llama.cpp folder",
  "dialog.llamacpp.action.browseModel": "Browse for GGUF model",
  "dialog.llamacpp.action.setup": "Save and start",
  "dialog.llamacpp.action.starting": "Starting local server...",
  "dialog.llamacpp.action.start": "Start server",
  "dialog.llamacpp.action.stop": "Stop server",
  "dialog.llamacpp.action.save": "Save configuration",
  "dialog.llamacpp.toast.stopped.title": "Local server stopped",
  "dialog.llamacpp.toast.stopped.description": "llama.cpp is no longer running",
  "dialog.llamacpp.discovered": "Discovered models on this machine",
  ...
  "dialog.provider.llamacpp.name": "Local llama.cpp (GGUF)",
    "dialog.llamacpp.status.runningManaged": "Running (managed by LocalCoder) · {{model}}",
  "dialog.llamacpp.status.runningExternal": "Running (external server on {{model}}) — Stop only works for LocalCoder-managed servers",
  "dialog.llamacpp.action.stopExternalHint": "This server was not started by LocalCoder. Stop it manually or restart the app.",
  "dialog.llamacpp.toast.saved.title": "Configuration saved",
  "dialog.llamacpp.toast.saved.description": "llama.cpp settings updated and model selected",
  "dialog.llamacpp.toast.providerPending.title": "Provider still loading",
  "dialog.llamacpp.toast.providerPending.description": "Open Select model in a moment — if missing, restart the app once.",
  "dialog.llamacpp.toast.stopExternal.title": "Could not stop server",
  "dialog.llamacpp.toast.stopExternal.description": "Another llama-server is still listening (not started by this app). Close it manually.",
  "dialog.provider.llamacpp.note": "Runs fully on your machine — no API key needed",

  "sidebar.gettingStarted.llama": "Or set up a local GGUF model with llama.cpp in one step.",
  "sidebar.gettingStarted.action.llama": "Set up local model",
}

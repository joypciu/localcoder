export const dict = {
  ...
  "dialog.provider.localcoder.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.localcoder.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.localcoderGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Visite ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados em localcoder.json",
  ...
  "dialog.server.description": "Trocar para qual servidor LocalCoder este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do LocalCoder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do LocalCoder",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (localcoder.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: LocalCoder ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor LocalCoder dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do LocalCoder",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o LocalCoder aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o LocalCoder segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o LocalCoder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o LocalCoder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do LocalCoder.",

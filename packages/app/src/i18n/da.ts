export const dict = {
  ...
  "dialog.provider.localcoder.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.localcoder.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.localcoderGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af LocalCoder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i LocalCoder.",
  ...
  "provider.connect.localcoderZen.line1":
    "LocalCoder Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.localcoderZen.visit.prefix": "Besøg ",
  "provider.connect.localcoderZen.visit.link": "localcoder.ai/zen",
  "provider.connect.localcoderZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i LocalCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i LocalCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i localcoder.json",
  ...
  "dialog.server.description": "Skift hvilken LocalCoder-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af LocalCoder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til LocalCoder-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (localcoder.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, LocalCoder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "LocalCoder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør LocalCoder-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for LocalCoder",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan LocalCoder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om LocalCoder følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan LocalCoder er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når LocalCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af LocalCoder.",

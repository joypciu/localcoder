...
export const loadMcpQuery = (directory: string, sdk?: localcoderClient) =>
  queryOptions({
    queryKey: [directory, "mcp"],
    queryFn: sdk ? () => sdk.mcp.status().then((r) => r.data ?? {}) : skipToken,
  })

export const loadLspQuery = (directory: string, sdk?: localcoderClient) =>
  queryOptions({
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, localcoderClient>()

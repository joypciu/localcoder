import type {
  ...
  Session,
  Todo,
} from "@localcoder-ai/sdk/v2/client"
...
export const loadGlobalConfigQuery = (
  ...
  transform?: (x: Awaited<ReturnType<localcoderClient["global"]["config"]["get"]>>) => void,
) =>
  queryOptions({
    queryKey: ["config"],
    queryFn: sdk
...
export const loadProjectsQuery = (
  sdk?: localcoderClient,
  transform?: (x: Awaited<ReturnType<localcoderClient["project"]["list"]>>["data"]) => void,
) =>
  queryOptions({
    queryKey: ["project"],
    queryFn: sdk
          ...
          retry(() =>
            sdk.project
              ...
              .then((x) => {
                return (x.data ?? [])
                  .filter((p) => !!p?.id)
                  .filter((p) => !!p.worktree && !p.worktree.includes("localcoder-test"))
                  .slice()
...
export const loadProvidersQuery = (directory: string | null, sdk?: localcoderClient) =>
  queryOptions({
...
export const loadAgentsQuery = (
  ...
  sdk?: localcoderClient,
  transform?: (x: Awaited<ReturnType<localcoderClient["app"]["agents"]>>) => void,
) =>
  queryOptions({
...
export const loadPathQuery = (
  directory: string | null,
  sdk?: localcoderClient,
  transform?: (x: Awaited<ReturnType<localcoderClient["path"]["get"]>>) => void,
) =>
  queryOptions<Path>({

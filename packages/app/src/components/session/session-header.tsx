import { AppIcon } from "@localcoder-ai/ui/app-icon"
...
import { Keybind } from "@localcoder-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_LOCALCODER_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("localcoder-titlebar-center"))
    setRightMount(document.getElementById("localcoder-titlebar-right"))
  })

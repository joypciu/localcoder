...
beforeAll(async () => {
  ...
  mock.module("@localcoder-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@localcoder-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@localcoder-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@localcoder-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

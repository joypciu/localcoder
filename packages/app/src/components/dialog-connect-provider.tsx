import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@localcoder-ai/sdk/v2/client"
...
import { List, type ListRef } from "@localcoder-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "localcoder"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.localcoderZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.localcoderZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.localcoderZen.visit.prefix")}
                <Link href="https://localcoder.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.localcoderZen.visit.link")}
                </Link>
                {language.t("provider.connect.localcoderZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>

...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new localcoderClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the LocalCoder system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the LocalCoder system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global LocalCoder configuration settings and preferences.
   */
   ...
   *
   * Update global LocalCoder configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the LocalCoder server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the LocalCoder system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all LocalCoder instances, releasing all resources.
   */
   ...
   * Upgrade localcoder
   *
   * Upgrade localcoder to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current LocalCoder configuration settings and preferences.
   */
   ...
   *
   * Update LocalCoder configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local LocalCoder state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current LocalCoder instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the LocalCoder system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with LocalCoder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that LocalCoder is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by LocalCoder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all LocalCoder sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new LocalCoder session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific LocalCoder session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class localcoderClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<localcoderClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    localcoderClient.__registry.set(this, args?.key)
  }

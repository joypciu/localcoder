export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من LocalCoder",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من LocalCoder، هل ترغب في تثبيته وإعادة تشغيله؟",

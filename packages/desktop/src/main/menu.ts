...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "LocalCoder Documentation", click: () => shell.openExternal("https://localcoder.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/localcoder") },
        { type: "separator" },
        { type: "separator" },
        {

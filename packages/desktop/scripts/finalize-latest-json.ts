...
const releaseId = process.env.LOCALCODER_RELEASE
if (!releaseId) throw new Error("LOCALCODER_RELEASE is required")

const version = process.env.LOCALCODER_VERSION
if (!version) throw new Error("LOCALCODER_VERSION is required")
...
const macxTarGz = "localcoder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "localcoder-desktop-mac-arm64.app.tar.gz"

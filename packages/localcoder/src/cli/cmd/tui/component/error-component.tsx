...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/localcoder/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("localcoder-version", InstallationVersion)

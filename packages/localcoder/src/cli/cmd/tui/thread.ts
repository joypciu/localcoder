...
async function target() {
  if (typeof LOCALCODER_WORKER_PATH !== "undefined") return LOCALCODER_WORKER_PATH
  ...
  handler: async (args) => {
    ...
    try {
      ...
      const env = sanitizedProcessEnv({
        [LOCALCODER_PROCESS_ROLE]: "worker",

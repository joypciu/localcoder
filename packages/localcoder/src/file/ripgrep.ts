...
import { sanitizedProcessEnv } from "@localcoder-ai/core/util/localcoder-process"
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".localcoder")) continue

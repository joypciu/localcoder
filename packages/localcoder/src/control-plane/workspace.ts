...
import { Slug } from "@localcoder-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.LOCALCODER_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LOCALCODER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LOCALCODER_WORKSPACE_ID: config.id,
        LOCALCODER_EXPERIMENTAL_WORKSPACES: "true",

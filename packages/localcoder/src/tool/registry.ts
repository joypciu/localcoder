...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@localcoder-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/ToolRegistry") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const questionEnabled =
          ["app", "cli", "desktop"].includes(Flag.LOCALCODER_CLIENT) || Flag.LOCALCODER_ENABLE_QUESTION_TOOL

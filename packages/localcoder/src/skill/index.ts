...
import { Glob } from "@localcoder-ai/core/util/glob"
...
const LOCALCODER_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.LOCALCODER_DISABLE_EXTERNAL_SKILLS) {
    if (!Flag.LOCALCODER_DISABLE_CLAUDE_CODE_SKILLS) externalDirs.push(CLAUDE_EXTERNAL_DIR)
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, LOCALCODER_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/Skill") {}

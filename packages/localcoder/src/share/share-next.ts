import type * as SDK from "@localcoder-ai/sdk/v2"
...
const disabled = process.env["LOCALCODER_DISABLE_SHARE"] === "true" || process.env["LOCALCODER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/ShareNext") {}

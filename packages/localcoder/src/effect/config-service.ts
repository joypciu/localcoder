 ...
 *   "@localcoder/ServerAuthConfig",
 *   {
 *     password: Config.string("LOCALCODER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("LOCALCODER_SERVER_USERNAME").pipe(Config.withDefault("localcoder")),
 *   },
 * ) {}
 *

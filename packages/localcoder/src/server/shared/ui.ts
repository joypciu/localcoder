...
const embeddedUIPromise = Flag.LOCALCODER_DISABLE_EMBEDDED_WEB_UI
  ? Promise.resolve(null)
  : // @ts-expect-error - generated file at build time
    import("localcoder-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null)
...
export const UI_UPSTREAM = new URL("https://app.localcoder.ai")
...
export function embeddedUI() {
  if (Flag.LOCALCODER_DISABLE_EMBEDDED_WEB_UI) return Promise.resolve(null)

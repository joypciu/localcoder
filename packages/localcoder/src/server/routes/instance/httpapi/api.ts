...
export const RootHttpApi = HttpApi.make("localcoder-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("localcoder-instance")
...
export const LocalCoderHttpApi = HttpApi.make("localcoder")

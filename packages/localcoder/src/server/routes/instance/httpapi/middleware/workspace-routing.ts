...
>()("@localcoder/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@localcoder/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.LOCALCODER_WORKSPACE_ID ? WorkspaceID.make(Flag.LOCALCODER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-localcoder-directory"] || process.cwd()
}

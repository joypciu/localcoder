...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.LOCALCODER_EXPERIMENTAL_HTTPAPI) {
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current LocalCoder instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the LocalCoder instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the LocalCoder system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the LocalCoder system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the LocalCoder system.",

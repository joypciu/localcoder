...
import { SimpleCliCommand, ReplCommand } from "./cli/cmd/simple-cli"
...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENT = "1"
    process.env.localcoder = "1"
    process.env.LOCALCODER_PID = String(process.pid)

    Log.Default.info("localcoder", {

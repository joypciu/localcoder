...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LOCALCODER_CALLER", () => {
    process.env["LOCALCODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LOCALCODER_CALLER", () => {
    process.env["LOCALCODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LOCALCODER_CALLER", () => {
    process.env["LOCALCODER_CALLER"] = "unknown"

...
const originallocalcoderPort = process.env.LOCALCODER_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.LOCALCODER_EDITOR_SSE_PORT = originallocalcoderPort
})
...
test("useEditorContext reconnect switches editor server by session directory", async () => {
  ...
  process.env.LOCALCODER_EDITOR_SSE_PORT = undefined
...
test("useEditorContext connects with LOCALCODER_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.LOCALCODER_EDITOR_SSE_PORT = "4020"

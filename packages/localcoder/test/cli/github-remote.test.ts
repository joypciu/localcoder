...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/localcoder.git")).toEqual({ owner: "sst", repo: "localcoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/localcoder")).toEqual({ owner: "sst", repo: "localcoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/localcoder.git")).toEqual({ owner: "sst", repo: "localcoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/localcoder")).toEqual({ owner: "sst", repo: "localcoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/localcoder.git")).toEqual({ owner: "sst", repo: "localcoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/localcoder")).toEqual({ owner: "sst", repo: "localcoder" })
})

...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips localcoder-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-localcoder-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-localcoder-directory")).toBeNull()
      expect(result.get("x-localcoder-workspace")).toBeNull()

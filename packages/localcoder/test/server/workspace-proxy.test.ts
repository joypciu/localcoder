...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips localcoder-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-localcoder-directory"]).toBeUndefined()
      expect(forwarded["x-localcoder-workspace"]).toBeUndefined()

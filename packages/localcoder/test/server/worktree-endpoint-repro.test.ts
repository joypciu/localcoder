...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      ...
      LOCALCODER_EXPERIMENTAL_WORKSPACES: Flag.LOCALCODER_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        ...
        Flag.LOCALCODER_EXPERIMENTAL_WORKSPACES = original.LOCALCODER_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),

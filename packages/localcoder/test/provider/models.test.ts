...
// test/preload.ts pins LOCALCODER_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.LOCALCODER_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.LOCALCODER_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.LOCALCODER_MODELS_PATH = undefined
  Flag.LOCALCODER_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.LOCALCODER_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.LOCALCODER_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})

...
Practical reference for the current tool-migration state in `packages/localcoder`.
...
Tool tests should use the existing Effect helpers in `packages/localcoder/test/lib/effect.ts`:

...
Practical reference for new and migrated Effect code in `packages/localcoder`.
...
export class Service extends Context.Service<Service, Interface>()("@localcoder/Foo") {}

...
- plugins get global "localcoder" instance like in that post i showed
- localcoder instance has stuff like `localcoder.session.prompt()` or
  `localcoder.tool.register({...})`
